...
def default_transport(
    ...
    *,
    ...
    raised) so the status map in :mod:`fuaran_ui.client.wire` sees them.
...
class FuaranClient:
    ...
    :class:`~fuaran_ui.client.session.FuaranSession` wraps it with the
    tree-carrying loop.
    """
    ...
    def __init__(
        ...
        *,
        ...
        """
        if endpoint.strip() == "":
            raise ValueError("fuaran_ui.client: `endpoint` is required.")
    ...
    def generate(
        ...
        *,
        ...
        Returns the typed :data:`~fuaran_ui.client.contract.TurnResult`
