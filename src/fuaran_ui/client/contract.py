...
change, and :mod:`fuaran_ui.client.wire` pins how each maps onto the HTTP
envelope.
...
#: :meth:`~fuaran_ui.client.client.FuaranClient.generate` echoes back whichever
...
class ProducedDetail:
    ...
    They hang off
    :meth:`~fuaran_ui.client.client.FuaranClient.generate_detailed` rather than
...
#: case (see :mod:`fuaran_ui.client.wire`).
