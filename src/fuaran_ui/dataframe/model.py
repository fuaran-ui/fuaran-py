...
evaluator runs identically (see :mod:`fuaran_ui.dataframe.codec` for the byte-exact
codec and :mod:`fuaran_ui.dataframe.evaluate` for the reference-parity evaluator).
