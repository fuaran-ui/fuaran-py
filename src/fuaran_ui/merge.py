"""``fuaran_ui.merge`` — deterministic author-agnostic 3-way tree merge.

The branching op-stream (:mod:`fuaran_ui.dag`) lets an AI branch and a human
...
(:func:`~fuaran_ui.canonical.encode_value`), the same oracle the corpus commits
