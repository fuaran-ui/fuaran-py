...
decoded op is modelled as an :class:`~fuaran_ui.model.Obj` whose ``tag`` is the
...
def decode_op(text: str) -> DecodeResult[Obj]:
    """Decode a canonical-wire ``TreeOp`` document into a tagged :class:`~fuaran_ui.model.Obj`."""
