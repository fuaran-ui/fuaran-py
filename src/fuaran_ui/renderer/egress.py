...
:mod:`fuaran_ui.renderer.sanitize` answers *is this URL safe to have*. It does
...
class Allowed:
    ...
    :func:`~fuaran_ui.renderer.sanitize.sanitize_url` would have returned, so an
...
Passes :func:`~fuaran_ui.renderer.sanitize.is_safe_attribute_name` and the
