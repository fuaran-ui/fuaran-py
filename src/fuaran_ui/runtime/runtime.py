...
It reuses, never re-implements: the Phase 239 :func:`fuaran_ui.renderer.render_html`
for markup + the reference ``fuaran-*`` class vocabulary, and the Phase 279
:func:`fuaran_ui.ops.apply` for op semantics. The runtime owns only the loop.
"""
