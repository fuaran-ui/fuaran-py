...
declarative :mod:`fuaran_ui.ui.compute` algebra that travels as data — and the
...
#:
#: Phase 1580 moved the definition into :mod:`fuaran_ui.schema.types`, beside
...
#: ``from fuaran_ui.ui.capability import Invoke`` keeps working and there is one
